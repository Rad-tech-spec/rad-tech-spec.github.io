...
function AutoExportLoaders({
  ...
  const filterPaths = _pluginutils.createFilter.call(void 0, loadersPathsGlobs);
  const filterPageComponents = typeof filterPagesOrGlobs === "function" ? filterPagesOrGlobs : _pluginutils.createFilter.call(void 0, filterPagesOrGlobs);
  return {
    name: PLUGIN_NAME,
    transform: {
      order: "post",
...
exports.createTreeNodeValue = createTreeNodeValue; exports.EditableTreeNode = EditableTreeNode; exports.createRoutesContext = createRoutesContext; exports.AutoExportLoaders = AutoExportLoaders; exports.src_default = src_default; exports.VueRouterAutoImports = VueRouterAutoImports;
