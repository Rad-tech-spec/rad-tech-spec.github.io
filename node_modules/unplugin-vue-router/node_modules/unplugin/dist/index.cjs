...
var import_webpack_virtual_modules = __toESM(require("webpack-virtual-modules"), 1);
...
function getSource(fileSource) {
  ...
  return new webpack.sources.RawSource(
    typeof fileSource === "string" ? fileSource : import_buffer4.Buffer.from(fileSource.buffer)
  );
}
