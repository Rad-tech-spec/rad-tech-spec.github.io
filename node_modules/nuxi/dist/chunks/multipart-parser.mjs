import 'node:fs';
import 'node:path';
import { r as requireNode, a as requireNodeFetchNative_DhEqb06g } from './init.mjs';
import 'node:http';
import 'node:https';
import 'node:zlib';
import 'node:stream';
