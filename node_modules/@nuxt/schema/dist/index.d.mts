 ...
 */
  ...
  */
   ...
   * 
  */
  builder: 'vite' | 'webpack' | 'rspack' | 'shared' | false | undefined,
  ...
  */
   ...
   * 
  */
  tsConfig: 0 extends 1 & VueCompilerOptions ? TSConfig : TSConfig & { vueCompilerOptions?: Omit<VueCompilerOptions, 'plugins'> & { plugins?: string[] } },
...
interface NuxtConfig extends DeepPartial<Omit<ConfigSchema, 'vue' | 'vite' | 'runtimeConfig' | 'webpack'>> {
...
interface NuxtOptions extends Omit<ConfigSchema, 'vue' | 'sourcemap' | 'builder' | 'postcss' | 'webpack'> {
